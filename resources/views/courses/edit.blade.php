...
<form action="{{ route('courses.update', $course) }}" method="POST">
  ...
  <div class="form-group">
    ...
    <input name="mensalidade" value="{{ old('mensalidade', $course->mensalidade) }}" type="text" class="form-control @if($errors->has('mensalidade')) is-invalid @endif" id="mensalidade" aria-describedby="mensalidade" placeholder="0000.00">    
  ...
  <div class="form-group">
    ...
    <input name="valor_matricula" value="{{ old('valor_matricula', $course->valor_matricula) }}" type="text" class="form-control @if($errors->has('valor_matricula')) is-invalid @endif" id="valor_matricula" aria-describedby="valor_matricula" placeholder="0000.00">    
